...
//    private static HbaseBasicApi.connection HbaseBasicApi.connection; // 管理Hbase
//    private static HbaseBasicApi.admin HbaseBasicApi.admin; // 管理Hbase数据库的表信息
    ...
    public static void createTable(String tableName, String[] fields) throws IOException {
        ...
        if (HbaseBasicApi.admin.tableExists(tablename)) {
            System.out.println("table is exists!");
            HbaseBasicApi.admin.disableTable(tablename);
            HbaseBasicApi.admin.deleteTable(tablename);//删除原来的表
    ...
    public static void main(String[] args) throws IOException {
        ...
        addRecord("student", "s001", new String[]{"score:Math"}, new String[]{"100"});
        scanColumn("student", "score");
        System.out.println("===============================================================");
        System.out.println("===============================================================");
        System.out.println("===============================================================");
        modifyData("student","s001","score","90");
        scanColumn("student", "score");
        HbaseBasicApi.close();
    }
